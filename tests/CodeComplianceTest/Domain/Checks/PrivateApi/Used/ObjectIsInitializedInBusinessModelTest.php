...
class ObjectIsInitializedInBusinessModelTest extends BaseCodeComplianceCheckTest
{
    /**
     * @return void
     */
    ...
    {
        // Arrange
        $codebaseSourceDto = $this->readTestCodebase('Used/ObjectIsInitializedInBusinessModel/');

        $persistenceInBusinessModelCheck = static::bootKernel()->getContainer()->get(ObjectIsInitializedInBusinessModel::class)
