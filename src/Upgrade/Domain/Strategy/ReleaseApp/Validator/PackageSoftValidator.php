...
{
    /**
     * @var array<\Upgrade\Domain\Strategy\ReleaseApp\Validator\Package\PackageValidatorInterface>
     */
    protected $validatorList = [];

    /**
     * @param array<\Upgrade\Domain\Strategy\ReleaseApp\Validator\Package\PackageValidatorInterface> $validatorList
     */
